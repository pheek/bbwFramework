%% \author
\renewcommand{\author}{Autor mit renewcommand author in 'bms.sty' definieren.}
%% \author
\newcommand{\grafikautor}{Grafikautor mit renewcommand author in 'bms.sty' definieren.}
%%E-Mail des Autohrs
\newcommand{\authoremail}{Autor E-Mail mit renewcommand «authoremail» in 'bms.sty' erstellen.}

%% \erstellungsdatum
\newcommand{\erstellungsdatum}{Datum mit renewcommand erstellungsdatum in 'bms.sty' definieren.}
%% Version des Dokumentes
\newcommand{\docversion}{Version mit renewcommand docversion in 'bms.sty' definieren.}
%% \doctitel
\newcommand{\doctitel}{Titel mit renewcommand doctitel in 'bms.sty' festlegen.}

%% \fachthema
\newcommand{\fachthema}{Fachthema via renewcommand in 'bms.sty' überschreiben.}%
%% \untertitel
%%\newcommand{\untertitel}{Untertitel via renewcommand 'untertitel' in 'bms.sty' überschreiben.}
\newcommand{\untertitel}{\fachthema{}}

\newcommand{\rechte}{\textbf{Rechte}

Nutzungsrechte: CC-NC-BY (2019-2026)
...
\paragraph{Präambel} Eine geschlechtsneutrale Bezeichnung von
  ...
  Alle Lesenden sind selbstverständlich gleichermaßen angesprochen.
