...
\ifisTALS{TALS\noTRAINER{\footnote{{\zueriFont{TALS «Technik, Architektur und Life Sciences
(Laboranten)»: Ausrichtung technisches Profil}}}}}%%
\fi%%
\ifisGESO{GESO\noTRAINER{\footnote{{\zueriFont{GESO: Ausrichtung \textbf{Ge}sundheit und \textbf{So}ziales}}}}}%%
\fi}%%
