...
\ifisTALS{TALS\noTRAINER{\footnote{{\cdciFont{TALS «Technik, Architektur und Life Sciences
(Laboranten)»: Ausrichtung technisches Profil}}}}}%%
\fi%%
\ifisGESO{GESO\noTRAINER{\footnote{{\cdciFont{GESO: Ausrichtung \textbf{Ge}sundheit und \textbf{So}ziales}}}}}%%
\fi}%%
