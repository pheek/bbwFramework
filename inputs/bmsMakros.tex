...
\GESO{%%
\olatLink{{\color{bbwFarbe}\Huge K}}{Kompendium}{https://olat.bbw.ch/auth/RepositoryEntry/572162163/CourseNode/106029172671728}{Kapitel #1; Seite #2; Aufg. #3}%%
}%% END GESO
}%%
...
\TALS{%%
\olatLink{{\color{bbwFarbe}\Huge S}}{Strukturaufgaben [SPF]}{https://olat.bbw.ch/auth/RepositoryEntry/21200903/CourseNode/102901160343445}{Kapitel #1; Seite #2; Aufgaben #3}%%
}%% END TALS
}%%

\newcommand{\olatLinkTALSStrukturaufgabenGLF}[3]{%%
\TALS{%%
\olatLink{{\color{bbwFarbe}\Huge S}}{Strukturaufgaben [GLF]}{https://olat.bbw.ch/auth/RepositoryEntry/21200903/CourseNode/102901160330506}{Kapitel #1; Seite #2; Aufgaben #3}%%
}%% END TALS
}%%
